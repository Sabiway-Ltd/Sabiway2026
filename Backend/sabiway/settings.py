...
INTERNAL_REVIEW_MODE = env.bool("INTERNAL_REVIEW_MODE", default=False)
...
PRODUCT_EVENT_RETENTION_DAYS = env.int("PRODUCT_EVENT_RETENTION_DAYS", default=180)
TECHNICAL_METRIC_RETENTION_DAYS = env.int("TECHNICAL_METRIC_RETENTION_DAYS", default=30)
...
MIDDLEWARE = [
    ...
    "operations.middleware.ApiMeasurementMiddleware",
...
DATABASES = {"default": dj_database_url.config(default=f"sqlite:///{BASE_DIR / 'db.sqlite3'}", conn_max_age=600, ssl_require=DATABASE_SSL_REQUIRE)}
...
STATIC_URL="/static/"; DEFAULT_AUTO_FIELD="django.db.models.BigAutoField"; AUTH_USER_MODEL="accounts.User"
...
SESSION_COOKIE_HTTPONLY=True; SESSION_COOKIE_SECURE=env.bool("SESSION_COOKIE_SECURE",default=SECURE_SSL_REDIRECT); SESSION_COOKIE_SAMESITE="Lax"
SESSION_COOKIE_AGE=env.int("SESSION_COOKIE_AGE",default=8*60*60); SESSION_EXPIRE_AT_BROWSER_CLOSE=True
CSRF_COOKIE_SECURE=env.bool("CSRF_COOKIE_SECURE",default=SECURE_SSL_REDIRECT); CSRF_COOKIE_SAMESITE="Lax"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_CLASSES": ("sabiway.throttles.SabiWayRateThrottle",),
    "DEFAULT_THROTTLE_RATES": {
        "anon":env("API_ANON_RATE",default="120/min"),"user":env("API_USER_RATE",default="1200/min"),"login":env("API_LOGIN_RATE",default="10/min"),"signup":env("API_SIGNUP_RATE",default="10/hour"),"password_reset":env("API_PASSWORD_RESET_RATE",default="12/hour"),"oauth":env("API_OAUTH_RATE",default="30/hour"),"token_refresh":env("API_TOKEN_REFRESH_RATE",default="120/hour"),"analytics":env("API_ANALYTICS_RATE",default="120/min"),
    },
}

CLOUDINARY_STORAGE={"CLOUD_NAME":env("CLOUDINARY_CLOUD_NAME",default=""),"API_KEY":env("CLOUDINARY_API_KEY",default=""),"API_SECRET":env("CLOUDINARY_API_SECRET",default="")}
...
SIMPLE_JWT={"ACCESS_TOKEN_LIFETIME":timedelta(minutes=env.int("JWT_ACCESS_MINUTES",default=30)),"REFRESH_TOKEN_LIFETIME":timedelta(days=env.int("JWT_REFRESH_DAYS",default=30)),"ROTATE_REFRESH_TOKENS":True,"BLACKLIST_AFTER_ROTATION":True,"UPDATE_LAST_LOGIN":False,"ALGORITHM":"HS256","SIGNING_KEY":SECRET_KEY,"VERIFYING_KEY":None,"AUTH_HEADER_TYPES":("Bearer",),"AUTH_HEADER_NAME":"HTTP_AUTHORIZATION","USER_ID_FIELD":"id","USER_ID_CLAIM":"user_id","TOKEN_TYPE_CLAIM":"token_type","JTI_CLAIM":"jti"}
