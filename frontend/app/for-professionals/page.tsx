...
export default function Page() {
  ...
  ]} primaryCta={{ href: "/signup", label: "Become a SabiWay Professional" }} secondaryCta={{ href: "/verification-info", label: "How verification works" }} note="Nigeria and the UK are the first optimised markets. The marketplace itself is designed so Professionals in other countries can still register and be found where they operate." />;
}
