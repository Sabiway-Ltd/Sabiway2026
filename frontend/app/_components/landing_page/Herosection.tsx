  ...
  return (
    <section className="w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 px-6 sm:px-10 md:px-16 pt-24 md:pt-40 pb-24 md:pb-36 items-center relative overflow-hidden">
      ...
      <div className="text-start md:text-left">
        ...
        <div className="flex gap-x-2 text-[0.95rem] flex-col md:flex-row mt-8 gap-y-3">
          <button 
            onClick={HandleWaitListPopUp}
            >
            <div className="w-[12rem] py-4 text-center bg-[#008753] md:mb-14 text-white rounded-lg font-semibold shadow hover:bg-[#006B42] transition ">
              Join App Waitlist
            </div>
          </button>
